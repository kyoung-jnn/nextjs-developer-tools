 ...
 */
export const createDefaultDetection = (): DetectionResult => ({
  routerType: "none",
  confidence: 0,
  detectedAt: Date.now(),
  indicators: [],
 ...
 * 기본 PageState 생성
 */
export const createDefaultPageState = (url: string): PageState => ({
  url,
  routerType: "none",
  isNextJs: false,
  payloads: [],
 ...
 * 기본 TabState 생성
 */
export const createDefaultTabState = (tabId: number): TabState => ({
  tabId,
  pageState: null,
