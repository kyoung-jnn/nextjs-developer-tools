 ...
 */
async function handleRouterDetected(
  tabId: number,
 ...
 */
async function handlePayloadExtracted(
  tabId: number,
 ...
 */
function broadcastPageStateUpdate(tabId: number, state: PageState): void {
 ...
 */
function requestDetection(tabId: number): void {
